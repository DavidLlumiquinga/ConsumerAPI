...
public class Window extends JFrame {
    ...
    public Window() {
        ...
        comboSol.setPreferredSize(new Dimension(50, 10)); // Establecer tamaño preferido

        comboCamara = new JComboBox<>(new String[]{"FHAZ", "RHAZ", "MAST", "CHEMCAM", "MAHLI", "MARDI", "NAVCAM", "PANCAM", "MINITES"});
        comboCamara.setPreferredSize(new Dimension(50, 10)); // Establecer tamaño preferido

        areaInfo = new JTextArea(20, 40);
    ...
    private void agregarComponentes() {
        ...
        panelSeleccion.add(Box.createVerticalStrut(10)); // Espacio entre los componentes
        ...
        panelIzquierdo.add(Box.createVerticalStrut(20)); // Espacio entre los paneles
    ...
    private void agregarBoton(JPanel panel, String nombreRover) {
        ...
        boton.addActionListener(e -> {
            ...
            new Thread(() -> {
                try {
                    Map<String, List<MarsFilter>> fotos = controller.fetchAndDisplayPhotos(nombreRover.toLowerCase(), camara, sol, areaInfo);
        ...
        panel.add(boton);
       // panel.add(Box.createVerticalStrut(10)); // Espacio entre los botones
    }
